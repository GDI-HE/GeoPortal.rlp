...
class RegistrationForm(forms.Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'id': 'password','title': _("Please enter a password that is at least 9 characters long, includes at least one uppercase letter, one lowercase letter, and one number."),'required': 'required','pattern': ".{9,}"}),label=_("Password"))
...
class ChangeProfileForm(forms.Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'id': 'change_profile_password', 'title': _("Please enter a password that is at least 9 characters long, includes at least one uppercase letter, one lowercase letter, and one number."), 'pattern': ".{9,}"}), label=_("New password "), required=False)
