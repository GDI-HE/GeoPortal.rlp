...
class FeedbackForm(forms.Form):
    first_name = forms.CharField(max_length=200, label=_("First name"), required=False, widget=forms.TextInput(attrs={'title':_("Please enter your first name."), 'maxlength': 200}))
    family_name = forms.CharField(max_length=200, label=_("Family name"), required=False, widget=forms.TextInput(attrs={'title':_("Please enter your last name."), 'maxlength': 200}))
...
class RegistrationForm(forms.Form):
    ...
    if USE_RECAPTCHA == 0:
        ...
        def __init__(self, *args, **kwargs): # Set the title of the captcha field (for chromium based browsers)
