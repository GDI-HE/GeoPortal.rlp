...
class RegistrationForm(forms.Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'title': _("Minimum 9 characters, allowed special characters: @#$%&+=!:-_"), 'pattern': ".{9,}", 'oninvalid':"this.setCustomValidity('" + str(_("Please use at least 9 characters.")) + "')", 'onchange':"try{setCustomValidity('')}catch(e){}", 'oninput':"setCustomValidity(' ')"}), label=_("Password"))
